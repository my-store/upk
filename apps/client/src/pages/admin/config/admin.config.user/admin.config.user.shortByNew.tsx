import { adminConfigUserListShortByNew } from '../../../../libs/redux/reducers/admin/admin.config.slice';
import type { RootState } from '../../../../libs/redux/store';
import { useDispatch, useSelector } from 'react-redux';
import { updateUserConfig } from '.';
import { getAdminConfig } from '..';

export default function AdminConfigUserShortByNew() {
    ...
    <div className="Admin-Config-User-Data">
      ...
      <input
        ...
        onChange={({ target: { checked } }) => {
          dispatch(adminConfigUserListShortByNew(checked));
